...
def macro_snapshot() -> Dict[str, float]:
    """
    Versión híbrida:
    1. Intenta leer el cache macro publicado en GitHub.
    2. Si no está disponible, devuelve fallback rápido local.
    No consulta FRED/World Bank/Yahoo en vivo para no bloquear el dashboard.
    """
